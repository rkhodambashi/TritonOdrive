...
def open_satellite_pvt_window() -> None:
    ...
    sample_period_var = tk.StringVar(value="0.1")
    ...
    pvt_pbias_enable_var = tk.StringVar(value="1")
    pvt_pbias_kp_var = tk.StringVar(value="0.75")
    pvt_pbias_adapt_var = tk.StringVar(value="0.5")
    pvt_pbias_max_var = tk.StringVar(value="0.5")
    pvt_pi_enable_var = tk.StringVar(value="1")
