...
#define ENDAT_DATA_READY_TIMEOUT_LOOPS 10000000UL
...
extern uint16_t Endat_waitForDataReady(uint16_t waitStep);
...
extern volatile uint16_t endatDataReadyTimeoutStep;
extern volatile uint32_t endatDataReadyTimeoutLoops;
